...
describe('TowerDefenceIssueRepository', () => {
  ...
  describe('getAllOpened', () => {
    it('should return only open issues', async () => {
      ...
      const result = await repository.getAllOpened(
    ...
    it('should use cached data on subsequent calls', async () => {
      ...
      await repository.getAllOpened('https://github.com/users/user/projects/1');
      await repository.getAllOpened('https://github.com/users/user/projects/1');
  ...
  describe('update', () => {
    ...
    it('should throw error for invalid project URL', async () => {
      ...
      await expect(repository.update(mockIssue, 'invalid-url')).rejects.toThrow(
