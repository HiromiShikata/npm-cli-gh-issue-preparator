...
export declare class NotifyFinishedIssuePreparationUseCase {
    ...
    constructor(projectRepository: Pick<ProjectRepository, 'getByUrl'>, issueRepository: Pick<IssueRepository, 'get' | 'update'>, issueCommentRepository: Pick<IssueCommentRepository, 'getCommentsFromIssue' | 'createComment'>);
    run: (params: {
        projectUrl: string;
        issueUrl: string;
